...
def upgrade() -> None:
    op.add_column(
        "foster_profiles", sa.Column("background_check_passed", sa.Boolean(), nullable=True)
    )
    ...
    op.add_column(
        "foster_profiles", sa.Column("vetted_at", sa.DateTime(timezone=True), nullable=True)
    )

    op.add_column(
        "foster_profiles", sa.Column("home_inspection_passed", sa.Boolean(), nullable=True)
    )
    ...
    op.add_column(
        "foster_profiles", sa.Column("inspected_at", sa.DateTime(timezone=True), nullable=True)
    )
