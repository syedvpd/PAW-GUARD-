...
def downgrade() -> None:
    op.execute("ALTER TABLE rescue_dispatch_agents DROP COLUMN IF EXISTS accepted_at")
    op.execute("ALTER TABLE rescue_dispatches DROP COLUMN IF EXISTS accepted_at")
