...
class TestDogEndpoints:
    ...
    async def test_list_dogs(self, client, setup):
        await call(client, "dogs", "GET", "/api/v1/dogs", headers=setup.admin_headers, expected=200)
    ...
    async def test_admin_get_dog(self, client, setup):
        ...
        await call(
            ...
            "dogs",
            "GET",
            f"/api/v1/dogs/admin/dogs/{dog_id}",
            headers=setup.admin_headers,
            expected=200,
        )
