...
class TestAdminEndpoints:
    ...
    async def test_list_roles(self, client, setup):
        await call(
            client, "admin", "GET", "/api/v1/admin/roles", headers=setup.admin_headers, expected=200
        )
    ...
    async def test_list_users(self, client, setup):
        await call(
            client, "admin", "GET", "/api/v1/admin/users", headers=setup.admin_headers, expected=200
        )
