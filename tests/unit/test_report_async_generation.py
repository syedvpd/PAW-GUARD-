...
async def test_create_report_job_returns_pending_immediately(mock_user: CurrentUser) -> None:
    ...
    # Verify background dispatch was initiated
...
async def test_background_tasks_execution_transitions_job_pending_to_running_to_done(
    ...
    """Proves executing the BackgroundTasks object generated by the API endpoint runs the worker and transitions job to DONE."""
    job_id = uuid.uuid4()
    job_row = ReportJob(
        id=job_id,
