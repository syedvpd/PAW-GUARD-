...
class AuthAuditEventType(StrEnum):
    ...
    ADOPTION_AGREEMENT_SIGNED = "adoption_agreement_signed"
    ADOPTION_WITHDRAWN = "adoption_withdrawn"
    ADOPTION_LOCK_REJECTED_SIBLING = "adoption_lock_rejected_sibling"
    ADOPTION_OVERRIDE_REVERSED = "adoption_override_reversed"
    ...
    SHELTER_VET_CHECK_REQUESTED = "shelter_vet_check_requested"
    ...
    PORTAL_INQUIRY_CREATED = "portal_inquiry_created"
    PORTAL_INQUIRY_UPDATED = "portal_inquiry_updated"
    PORTAL_INQUIRY_ASSIGNED = "portal_inquiry_assigned"
    PORTAL_INQUIRY_RESPONDED = "portal_inquiry_responded"
    PORTAL_STORY_SUBMITTED = "portal_story_submitted"
    PORTAL_STORY_REJECTED = "portal_story_rejected"
