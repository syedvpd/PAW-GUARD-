...
class FleetService:
    ...
    async def create_vehicle(
        ...
        if payload.primary_driver_id is not None and not await self._repo.user_exists(payload.primary_driver_id):
            raise NotFoundError(f"Primary driver user with ID '{payload.primary_driver_id}' not found.")
