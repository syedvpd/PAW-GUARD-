"""Repeatable: seeds published animal rescue and adoption success stories."""
...
from pawguard.modules.auth import (
    models as auth_models,  # noqa: F401  registers User for AuditMixin FKs
)
from pawguard.modules.companion_pet import (
    models as companion_pet_models,  # noqa: F401  registers SafetyTag
)
...
from pawguard.modules.shelter import (
    models as shelter_models,  # noqa: F401  registers shelter_sections
)
