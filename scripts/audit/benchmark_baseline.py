"""Benchmark tooling: measures baseline API latency and throughput across core endpoints."""
    ...
    async def run_explain_analyze(self) -> list[dict[str, Any]]:
        ...
        queries_to_explain = [
            ...
            (
                ...
                "SELECT * FROM donations WHERE donor_id = (SELECT id FROM donor_profiles LIMIT 1) ORDER BY created_at DESC LIMIT 20;",
            ),
            (
